...
const Cards = () => {
 ...
 const [InfoProveedorList,setInfoProveedor] = useState([]);
  ...
  const getInfoCatMovimiento = ()=>{
    Axios.get("http://localhost:3001/infoCatMovimiento").then((response)=>{
      setInfoCatMovimiento(response.data);
    });
  }
  getInfoCatMovimiento();
  const getInfoTipoMovimiento = ()=>{
    Axios.get("http://localhost:3001/infoTipoMovimiento").then((response)=>{
      setInfoTipoMovimiento(response.data);
    });
  }
  getInfoTipoMovimiento();
  const getInfoMovimiento = ()=>{
    Axios.get("http://localhost:3001/infoMovimiento").then((response)=>{
      setInfoMovimiento(response.data);
    });
  }
  ...
  getInfoPersonal();
    const getInfoProveedor = ()=>{
    Axios.get("http://localhost:3001/infoProveedor").then((response)=>{
      setInfoProveedor(response.data);
    });
  }
  getInfoProveedor();
  const limpiarCampos=()=>{
  ...
  const add = ()=>{
    ...
    fecha_Mov:fecha_Mov,
    cant_Mov:cant_Mov,
    val_unidad_Mov:val_unidad_Mov,
    val_Total_Mov:val_Total_Mov
    }).then(()=>{
      getInfoMovimiento();
      limpiarCampos();
      Swal.fire({
  ...
  const update = ()=>{
    Axios.put("http://localhost:3001/updateCatMovimiento",{

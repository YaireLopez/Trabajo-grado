...
const Tables = () => {
  ...
  const limpiarCamposMov=()=>{
    setnom_CatMov("");
    setdescripcion_CatMov("");
    setEditar(false);
  }
  const add = ()=>{
    Axios.post("http://localhost:3001/Tables",{
      nom_CatMov:nom_CatMov,
      descripcion_CatMov:descripcion_CatMov
    }).then(()=>{
            ...
            <FormGroup>
              ...
              </FormGroup>
              {
                ...
                <div>
                  ...
                  <Button onClick={limpiarCamposMov} color="secondary" className="btnCancelar m-2">Cancelar</Button>
                </div>
